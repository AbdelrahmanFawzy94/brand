...
import { IApisResponse } from '@app/@shared';
...
export class HttpService {
  ...
  getAsHttpResponse(
    ...
    return this.http
      .get(url, options && Object.keys(options).length ? { ...options, observe: 'response' } : { observe: 'response' })
      .pipe(
  ...
  postAsHttpResponse(
    ...
    return this.http
      .post(
        url,
        body,
        options && Object.keys(options).length ? { ...options, observe: 'response' } : { observe: 'response' }
      )
      .pipe(
        map((data) => data as HttpResponse<IApisResponse>),
        catchError((error) => {
